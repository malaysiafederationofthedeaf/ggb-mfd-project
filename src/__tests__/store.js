...
describe('Test check if group & groupCategory is in release and get vocab item & detail functions', () => {
    ...
    test('isGroupCategoryInRelease(groupEng, categoryEng)', () => { 
        Store.getVocabsItems.mockReturnValue(vocabsItems);

        expect(Store.isGroupCategoryInRelease("general", "number")).toBeTruthy();
        expect(Store.isGroupCategoryInRelease("General", "Number")).toBeFalsy();
        expect(Store.isGroupCategoryInRelease("General", "alphabet")).toBeFalsy();

        expect(Store.isGroupCategoryInRelease("health", "disabilities")).toBeTruthy();
        expect(Store.isGroupCategoryInRelease("people", "occupation")).toBeTruthy();    
        expect(Store.isGroupCategoryInRelease("people", "greetings")).toBeFalsy();      

        expect(Store.isGroupCategoryInRelease("food", "food")).toBeFalsy();
    });     
