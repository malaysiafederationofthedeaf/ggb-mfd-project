...
describe('Test get image source functions', () => {
    test('Test getCategoryImgSrc(kategori)', () => {
        ...
        expect(Store.getCategoryImgSrc("Non Existing Category")).toEqual(require("../images/general/coming-soon.avif"));
    });
    ...
    test('Test getSignImgSrc(kategori)', () => {
        ...
        expect(Store.getSignImgSrc("Non Existing Category")).toEqual(require("../images/general/coming-soon.avif"));
    });
});
